...
class DexGripperMultiGraspingEnv(MujocoEnv, utils.EzPickle):
    def __init__(self, cfg, agent):
        ...
        if self.cfg.xml_name == "default":
            self.model_xml_file = os.path.join(cfg.project_path, "assets", "mujoco_envs", "dex_gripper_multi_grasping.xml")
        else:
